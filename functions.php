<?php
    ...
    add_action('wp_enqueue_scripts', function(){
        wp_enqueue_style('bootsrap', PIROLL_DIR_CSS . 'bootstrap.min.css');
        ...
        wp_enqueue_script('js', PIROLL_DIR_JS . 'js.js');
    ...
    function create_posttype() {
        register_post_type( 'services_content',
        // CPT Options
          array(
            'labels' => array(
              'name' => __( 'services_content' ),
              'singular_name' => __( 'services_content' )
            ),
            'public' => true,
            'has_archive' => true,
            'rewrite' => array('slug' => 'services_content'),
            'show_in_rest' => true,
          )
        );
